...
export type ServiceRequest =
  ...
  // `kg:profile *-view` (Aperas-treeview-design.md §11) — a `TreeView`'s own `name` plays exactly
  // the addressable role `Profile.handle` does (stable, globally-unique, "set up before use"), so
