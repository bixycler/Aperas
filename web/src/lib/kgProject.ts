...
import { wrap, hasHolderDescendant, deriveAbstractFromLiveChildren, type ArtifactNode, type FolderNode, type TreeNode } from './apeironNgn/node';
import { getArtifactsDir, computeFileHash } from './artifacts';
